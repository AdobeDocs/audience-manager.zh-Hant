   ...
   + 目的地{#destinations}
      ...
      + 以人物為基礎的目的地 {#people-based}
         ...
         + 實作指南 {#implementation-guide}
            ...
            + [工作流程A — 以所有線上活動和離線資料為基礎的個人化](features/destinations/people-based-destinations-workflow-combined.md)
            + [工作流程B — 以僅限離線資料為基礎的個人化](features/destinations/people-based-destinations-workflow-offline.md)
            + [工作流程C — 以結合離線資料的驗證活動為基礎的個人化](features/destinations/people-based-destinations-workflow-authenticated.md)
