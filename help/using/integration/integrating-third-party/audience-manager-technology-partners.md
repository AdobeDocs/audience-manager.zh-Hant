...
| Collective AMP Platform | 27/02/2017 | 否 | 否 | 否 | 否 |
...
| Google DoubleClick促銷活動管理員(DCM fka DFA) | 24/04/2017 | 是 | 是 | 是 | 是 |
...
| Sizmek Audience Hub | 17/02/2017 | 有 | 否 | 否 |  |
| 切片交易 | 04/09/2018 | 有 | 否 | 否 | 是 |
| Smart Adserver | 31/07/2017 | 有 | 否 | 是 | 是 |
| So-net Media Networks Logicad |  | 有 | 否 | 否 |  |
