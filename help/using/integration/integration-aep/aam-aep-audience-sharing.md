...
>[!IMPORTANT]
>
> 本節說明從Experience Platform到Audience Manager的舊版區段共用整合。 您現在可以設定這項整合，而不需要Adobe客戶代表的支援。 如需詳細資訊，請閱讀[Experience Cloud對象](https://experienceleague.adobe.com/docs/experience-platform/destinations/catalog/adobe/experience-cloud-audiences.html?lang=zh-Hant)目的地檔案。
