  ...
  <tr> 
   ...
   <td colname="col2"> <p>此D會告訴 <span class="keyword"> Audience Manager</span> ，資料檔案是否包含您自己的使用者ID、Android或iOS ID。 接受下列選項： </p> 
    <ul id="ul_818EB3EB2E5543F0B048BCEBB6699562"> 
     ...
     <li id="li_1955911BA11F4F458227B77F383F25A3"> <b></b> Android ID(GAID):如果資料檔案名稱包含Android ID，請使用ID 20914。 例如，告 <code>...ftp_dpm_20914_123456789.sync</code> 訴 <span class="keyword"> Audience Manager</span> ，資料檔案僅包含Android ID。 </li> 
