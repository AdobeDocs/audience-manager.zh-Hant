...
# 傳入資料檔案的FTP名稱和檔案大小要求{#ftp-name-and-file-size-requirements-for-inbound-data-files}
  ...
  <tr> 
   ...
   <td colname="col2"> <p>此D會告訴 <span class="keyword"> Audience Manager</span> ，資料檔案是否包含您自己的使用者ID、Android或iOS ID。 接受下列選項： </p> 
    <ul id="ul_818EB3EB2E5543F0B048BCEBB6699562"> 
     ...
     <li id="li_1955911BA11F4F458227B77F383F25A3"> <b></b> Android ID(GAID):如果資料檔案名稱包含Android ID，請使用ID 20914。 例如， <code>...ftp_dpm_20914_123456789.sync</code> 告知 <span class="keyword"> Audience Manager</span> ，資料檔案僅包含Android ID。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>同步選項包括： </p> <p> 
     <ul id="ul_DAAF61EC636C4456BECDDC34C3F86E83"> 
      ...
      <li id="li_8FE8430C2C004F87835D55231A0D99C9"> <code> 覆寫</code>:可讓客戶和資料提供者依每位使用者傳送特徵清單，這些特徵應會覆寫Audience Manager中指定資料來源的該使用者所有現有特徵。 您不需要將所有使用者納入覆寫檔案中。 僅包含您要變更的使用者。 未指派給目標資料來源的特徵將不會被清除。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
