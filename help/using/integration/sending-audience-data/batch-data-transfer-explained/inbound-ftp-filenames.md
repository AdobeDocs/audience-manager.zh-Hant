...
說明將資料傳送至[!DNL Audience Manager]時，您需遵循的必填欄位、語法、命名慣例和檔案大小。 將資料傳送至Audience Manager [!DNL FTP]目錄時，請根據這些規格設定檔案的名稱和大小。
