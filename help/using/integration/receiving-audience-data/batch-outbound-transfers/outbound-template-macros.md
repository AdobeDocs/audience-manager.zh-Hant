...
<p>上述範例中的最後三位(001,002,003)是SPLITNUM識別碼。</p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>10位數的UTC、Unix時間戳記。 </p> <p>也可以格式化為 <code> &lt;TIMESTAMP;format="YYYYMMDDhhmmss"&gt;遵循Java日 </code> 期／時間戳記格式規則。 </p> </td> 
  </tr>
...
<table id="table_5C6F9678CFF34C5EB67BA1DEA0479F1D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>此巨集的輸出會將資料提供者ID(DPID)對應至相關的唯一使用者ID(DPUUID)。 此宏必須具有格式字串才能控制其輸出。 範例輸出看起來類似下列： </p> <p> <code> "dpids=dpid1,dpid2,...dpid n|maxMappings= n|format=json" </code> </p> <p>最大 <code> 映射 </code> 設定確定希望宏返回的映射數。 當 <code> maxMappings=0 </code>時，此巨集會傳回每個指定DPID的所有映射。 資料會依時間戳記（最新的先行）排序，並傳回最大時間戳記優先的結果。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> 退出 </code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳回 <code> 1 </code> 作為靜態、硬式編碼值。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳回清單中的區段清單。 接受以下可選參數： </p> 
    <ul id="ul_B111AA0D6C18445598A1444B8B7E9325"> 
     ...
     <li id="li_9BE103EFD8384464B46FAC00422431DB"> <code> 類型 </code>:傳回 <code> 5 </code>個靜態、硬式編碼值，可將資料識別為區段資料。 </li> 
    ...
    </ul> <p>將這些變數放在巨集後面的大括弧中。 例如，此程式碼會以垂直號"|"字元分隔結果： <code> &lt;SEGMENT_LIST:{seg|&lt;seg.type&gt;,&lt;seg.sid&gt;};分隔符="","&gt; </code> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳回特徵清單。 接受以下可選參數： </p> 
    <ul id="ul_E9CDC4DD47B9435086FF42143D9E8177"> 
     <li id="li_4BBC57F0D7874F8EA8C6D39DB3572257"> <code> 類型 </code>:依數值ID識別特徵類型。 傳回: 
      <ul id="ul_D2357E6CF47B4EBC8D3772D17B2EADA3"> 
       <li id="li_C6C2A019FCD945E085E1ABB564C4EDAD"> <code> 10 </code> 識別DPM特徵（離線，由傳入工作加入）。 </li> 
       <li id="li_7AFF8A1D0E1140459CC95CF43A97B9B6"> <code> 3識 </code> 別規則型特徵（即時，透過DCS加以封裝）。 </li> 
      </ul> </li> 
     <li id="li_1DDE25334CF9479A8C4738F3CB3C40AA"> <code> traitId </code>:特徵ID。 </li> 
     <li id="li_DCB89F2A40BB43C98EE3C84B5B3CDD33"> <code> lastEmaried </code>:上次這個特徵實現時。 Unix時間戳記。 </li> 
    </ul> <p>將這些變數放在巨集後面的大括弧中。 例如，此程式碼會以垂直號"|"字元分隔結果： <code> &lt;TRAIT_LIST:{trait|&lt;trait.Id&gt;,&lt;trait.lastEmaried&gt;};separator="," </code> </p> </td> 
  </tr> 
  <tr> 
