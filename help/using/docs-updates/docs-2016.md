...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在2016年5月更新Google後，您可以在標籤的自訂HTML區段中載入DIL程式碼。 您不再需要遠端托管程式碼。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-data-collection.md"> 資料收集和產品整合常見問題集 </a> </p> </td> 
   <td colname="col2"> <p>包含關於白名單的新項目 <span class="keyword"> Audience Manager</span> IP和FTP位址。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>說明新DIL方法的檔案，可讓您將資料傳送至 <span class="keyword"> Audience Manager</span> 來自Google的Universal Analytics。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> 處理訪客ID驗證狀態 <code> UNKNOWN</code> 和 <code> LOGGED_OUT</code> 同樣地。 本檔案提供我們如何處理的詳細資訊 <code> setCustomerID</code> 事件呼叫。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>請參閱本檔案，以取得 <span class="keyword"> Audience Manager</span> ID。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-audience-lab.md"> Audience Lab 常見問題集 </a> </p> </td> 
   <td colname="col2"> <p>關於 <span class="wintitle"> Audience Lab</span> 功能。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>說明 <span class="wintitle"> 目的地</span> 登陸頁面。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">新增透過OAuth 2.0通訊協定保護即時傳出資料傳輸的功能。 請連絡您的 <span class="keyword"> Adobe Audience Manager</span> 顧問快速入門。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修訂以注意 <code> GA.init()</code> 無法搭配最新版Google分析程式碼使用， <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>此功能已停用。</i><p>修訂以包含 <span class="keyword"> Adobe Experience Cloud Device Co-op</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> 用於Experience Cloud的Cookie</a> </td> 
   <td colname="col2"> 將Demdex Cookie和合作夥伴Cookie的存留時間(TTL)值修改為180天，以符合法國CNIL法規。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../dil/dil-overview.md"> 瞭解 Data Integration Library (DIL) </a> </td> 
   <td colname="col2">的一般概觀 <span class="wintitle"> 資料資訊庫</span> (DIL)。 </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新說明DIL為何使用 <code> GET</code> 和 <code> POST</code> 在事件呼叫中傳送資料的方法。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新 <span class="wintitle"> Audience Optimization</span>具有跨管道轉換、角色型存取控制、轉換群組和「回報的轉換特徵」報表的報表。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>此 <span class="wintitle"> 跨管道轉換</span> 選項 <span class="wintitle"> Audience Optimization</span> 報表可讓您將離線轉換歸因於提供的線上曝光數或點按次數。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> 使用平台層級的索引鍵進行裝置定位 </a> </td> 
   <td colname="col2"> <p>此新檔案說明常用的平台層級索引鍵值組，您可用來鎖定Audience Manager帳戶中所有屬性中具有裝置相關變數的使用者。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>從 <span class="keyword"> Audience Manager</span> 檔案。 移至 <span class="keyword"> Analytics</span> 檔案。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 透過像素呼叫擷取行銷活動的曝光資料 </a> </p> </td> 
   <td colname="col2"> <p>更新以包含以 <code> d_cid</code>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html" format="https" scope="external"> Audience ManagerAnalytics中的區段</a> </p> </td> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>新增命名運算子， <code> Matcheswords</code>. 這可讓您指定相符的字詞模式，而不使用規則運算式。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>說明如何 <span class="wintitle"> Audience Marketplace</span> 資料提供者會停用訂閱者的摘要。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> 供應商停用我的資料饋送之後會發生什麼事 </a> </p> </td> 
   <td colname="col2"> <p>說明 <span class="wintitle"> Audience Marketplace</span> 若提供者撤銷資料摘要的存取權，資料購買者便可預期。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS 錯誤碼、訊息和範例 </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修訂 <code> declaredId</code>. Customer ID 僅能以未編碼值傳入。編碼 ID 將會建立雙重編碼的識別碼。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 透過像素呼叫擷取行銷活動的曝光資料 </a> </p> </td> 
   <td colname="col2"> <p>新增 <code> d_mid</code> 和 <code> d_region</code>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>新增 <span class="wintitle"> 事件類型</span>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>列出並定義 <span class="wintitle"> Audience Marketplace</span> 帳單報告。 </p> </td> 
  </tr> 
  <tr> 
