...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>包含有關白名單<span class="keyword"> Audience Manager</span> IP和FTP位址的新項目。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience </span> Manager會以相同的方 <code> UNKNOWN</code> 式 <code> LOGGED_OUT</code> 處理訪客ID驗證狀態。本檔案提供我們如何處理<code> setCustomerID</code>事件呼叫的詳細資訊。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>請參閱本檔案以取得<span class="keyword"> Audience Manager</span> ID的完整清單。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>說明「可定址對象」<span class="wintitle">和「目標」<span class="wintitle">「可定址對象」之時間間隔如何運作的新內容。</span></span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>說明<span class="wintitle">目標</span>登陸頁面功能的新內容。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">已新增透過OAuth 2.0通訊協定保護即時傳出資料傳輸的功能。 請連絡您的<span class="keyword"> Adobe Audience Manager</span>顧問以開始使用。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修訂為注意<code> GA.init()</code>無法與最新版Google分析代碼<code> analytics.js</code>搭配使用。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已修訂，加入有關<span class="keyword"> Adobe Experience Cloud Device Co-op</span>的更多資訊。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/help/zh-Hant/core-services/interface/ec-cookies/cookies-am.translate.html" format="https" scope="external"> Experience Cloud中使用的Cookie</a> </td> 
   <td colname="col2"> 已將Demdex Cookie和合作夥伴Cookie的存留時間(TTL)值修改為180天，以符合法文CNIL法規。 </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新內容，說明DIL為何在事件呼叫中使用<code> GET</code>和<code> POST</code>方法來傳送資料。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已更新「<span class="wintitle">對象最佳化</span>」報表，包含跨通道轉換、以角色為基礎的存取控制、轉換群組和報告的轉換特徵報表。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle">觀眾最佳化</span>報表中的<span class="wintitle">跨通道轉換</span>選項可讓您將離線轉換歸因於提供的線上印象或點按。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新為包含傳遞具有<code> d_cid</code>的行動ID。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修訂版本會大幅變更目標檔案的內容與組織。 這些變更旨在降低複雜性，並讓Cookie和URL目標工作流程更清晰。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>說明<span class="wintitle"> Audience Marketplace</span>資料提供者如何停用訂閱者的動態消息。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> 供應商停用我的資料饋送之後會發生什麼事 </a> </p> </td> 
   <td colname="col2"> <p>說明<span class="wintitle"> Audience Marketplace</span>資料購買者在供應商廢止資料饋送的存取權時可預期的內容。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS 錯誤碼、訊息和範例 </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 透過像素呼叫擷取行銷活動的曝光資料 </a> </p> </td> 
   <td colname="col2"> <p>已為<code> d_mid</code>和<code> d_region</code>新增索引鍵和巨集項目。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>已新增<span class="wintitle">事件類型</span>的新說明。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>列出並定義<span class="wintitle"> Audience Marketplace</span>帳單報表中項目的新檔案。 </p> </td> 
  </tr> 
  <tr> 
