...
如需對 [其他解決方案所做的變更](https://docs.adobe.com/content/help/en/release-notes/experience-cloud/current.html) ，請參閱 [!DNL Audience Manager] Experience Cloud發行說明 [!DNL Experience Cloud] 。 如需舊版 [發行說明](../docs-updates/docs-2018.md) ，請參閱「上一年」一節。
...
版本注意事項 [!DNL Audience Manager] 和檔案變更的連結。 如需舊版變更的封存，請 [!DNL Experience Cloud] 參閱上一 [版發行說明](https://docs.adobe.com/content/help/en/release-notes/experience-cloud/current.html) 。
