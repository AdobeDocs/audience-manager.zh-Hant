...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>為了參考，我們將保留屬性<code> d_dst_filter</code>和<code> d_rs</code>新增至記錄的<code> d_</code>屬性。 我們建議不要建立使用保留屬性的特徵。 Adobe可隨時更改保留屬性。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>了解為什麼要將DCM記錄檔匯入<span class="keyword">Audience Manager</span>，並了解如何開始使用此功能，建議使用<span class="wintitle">可操作的記錄檔</span>。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>新增步驟7，說明在設定DCM資料檔案匯入至<span class="keyword">Audience Manager</span>後，您需要執行哪些動作來啟用<span class="wintitle">可操作的記錄檔</span>。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>一種新配置，可控制如何將資料發送到<span class="keyword">Experience CloudDevice Co-op</span>。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>以新定義修訂，說明<span class="wintitle">設定檔合併規則</span>如何影響報表編號。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b><span class="uicontrol">編輯</span></b>工作流程可讓您變更資料夾特徵的資料來源。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> 區段產生器的特徵和區段母體資料</a> </p> </td> 
   <td colname="col2"> <p>將量度從<span class="wintitle">獨特特徵實現</span>變更為<span class="wintitle">特徵母體總數</span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder.md"> 從區段中移除特徵</a> </p> </td> 
   <td colname="col2"> <p>關於如何使用<span class="wintitle">區段產生器</span>從區段移除特徵的指示。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>本檔案的新章節，強調<span class="wintitle"> Audience Lab</span>功能的數個使用案例。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#compare-models"> 在Audience Lab中比較模型</a> </p> </td> 
   <td colname="col2"> <p>您可以在<span class="keyword">Audience Manager</span>中使用數種不同的模型類型和來源。 <span class="wintitle"> 受眾</span> 標籤提供比較使用中模型客戶轉換率的簡單方式。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#testing-creatives"> 測試各目的地的創意素材</a> </p> </td> 
   <td colname="col2"> <p>使用<span class="wintitle"> Audience Lab</span>測量創意在不同目的地推動的轉換次數。 此使用案例也可讓您測量創意內容的轉換與自然發生的轉換。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-profile-merge.md"> 設定檔合併規則常見問題集</a> </p> </td> 
   <td colname="col2"> <p>新增常見問題集，協助回答常見的<span class="wintitle">設定檔合併規則</span>和裝置圖表問題。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>新增附註，說明7天和30天回顧期間僅適用於週日<b><span class="uicontrol">日期至</span></b>日期。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修訂內容以指出下列項目： </p> 
    <ul id="ul_99C2ACF7B28F442B8F66A40525F1CAE3"> 
     ...
     <li id="li_5012C420AC544B858246598575E59D8C">上傳之前，檔案必須壓縮為gzip，且副檔名為<code> .gz</code>。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> 區段產生器的特徵和區段母體資料</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已新增有關<span class="keyword">Audience Manager</span>呼叫<code> demdex.net</code>網域的原因的新檔案。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md">DCS API 呼叫的支援屬性</a>。 </p> </td> 
   <td colname="col2"> <p>更新「金鑰變數前置詞<code> _p</code>」，識別Audience Manager中的私人參數。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在「<b><span class="uicontrol">瀏覽所有特徵</span></b>」進階搜尋中新增進一步的搜尋和篩選功能。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>本節包含支援<span class="wintitle">設定檔連結</span>和協力廠商裝置圖表選項的新內容和修訂內容。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">在「傳出檔案」中新增選用的檔案名稱元素<code> PID-ALIAS</code>。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://docs.adobe.com/content/help/en/core-services/interface/more-resources/dns-prefetch.html" format="https" scope="external"> 搭配不同的Experience Cloud解決方案使用DNS預先擷取</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修訂說明並新增相關連結至<code> DIL.create</code>的<code> containerSNID</code>屬性。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> 可定址對象量度</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>以<span class="keyword">Audience Manager</span>處理之行動裝置ID(DAID)的預期格式更新。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新增說明<span class="keyword">Experience Cloud</span> <span class="wintitle">組織ID</span>的新項目，包括如何尋找的資訊。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
...
[!DNL Audience Manager]發行說明和檔案變更的連結。 如需[!DNL Experience Cloud]層級舊變更的封存，請參閱[上一版發行說明](https://docs.adobe.com/content/help/en/release-notes/experience-cloud/current.html)區段。
