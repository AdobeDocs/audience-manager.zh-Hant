...
[!DNL Audience Manager]發行說明和檔案變更的連結。 如需[!DNL Experience Cloud]層級舊版變更的封存，請參閱[上一版的發行說明](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html)區段。
