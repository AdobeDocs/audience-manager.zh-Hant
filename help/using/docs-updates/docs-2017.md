...
<table id="table_366914EEDA294636A580F706AFC57ACC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html?lang=zh-Hant" format="https" scope="external"> Audience Manager Cookie</a> </p> </td> 
...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>特徵資格或特徵實現在Audience Manager中的處理方式會有所不同，端視特徵型別而定。 本檔案詳細說明每種特徵型別的資格特性。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>「特徵引發總數」已重新命名為「Audience Manager使用者介面中的特徵實現總數」 。 我們已更新常見問題集以反映此修改。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新增步驟7，說明設定DCM資料檔案匯入至<span class="wintitle"> Audience Manager</span>後，啟用<span class="keyword">可操作的記錄檔</span>所需執行的動作。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><i>此功能已過時。</i> <p>控制如何將資料傳送至<span class="keyword"> Experience Cloud Device Co-op</span>的新設定。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>區段產生器<a href="../features/segments/segment-builder-data.md">中的</a>特徵和區段母體資料 </p> </td> 
   <td colname="col2"> <p>已使用新定義修訂，以說明<span class="wintitle">設定檔合併規則</span>如何影響報表編號。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>資料購買者適用的<a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-data-buyers.md"> Audience Marketplace</a> </p> </td> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../integration/sending-audience-data/batch-data-transfer-explained/batch-data-transfer-overview.md">將批次資料傳送至Audience Manager概觀</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>索引鍵變數<a href="../features/traits/trait-variable-prefixes.md">的</a>首碼需求 </p> </td> 
   <td colname="col2"> <p>以<code> _p</code>更新金鑰變數首碼，識別Audience Manager中的私人引數。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/more-resources/dns-prefetch.html?lang=zh-Hant" format="https" scope="external">搭配不同的Experience Cloud解決方案使用DNS預先擷取</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修訂說明並新增連結至<code> containerSNID</code>的<code> DIL.create</code>屬性。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics">個可定址對象量度</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已更新為<span class="keyword"> Audience Manager</span>所處理的行動裝置ID (DAID)的預期格式。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新增說明<span class="keyword"> Experience Cloud</span> <span class="wintitle">組織識別碼</span>的專案，包括如何尋找它的資訊。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
