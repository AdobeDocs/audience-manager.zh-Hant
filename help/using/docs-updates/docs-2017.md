...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>為便於參考，我們將保留屬性<code> d_dst_filter</code>和<code> d_rs</code>添加到說明的<code> d_</code>屬性中。 我們建議不要建立使用保留屬性的特徵。 Adobe得隨時變更保留屬性。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md">DCS API 呼叫的支援屬性</a>。 </p> </td> 
   <td colname="col2"> <p>已新增<code> d_cts</code>作為DCS請求可用金鑰清單中的選用參數。 您必須連絡Adobe Audience Manager顧問或客戶服務才能啟用它。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>瞭解為何<span class="wintitle">可操作的記錄檔</span>是將DCM記錄檔匯入<span class="keyword"> Audience Manager</span>的建議方式，並瞭解如何開始使用此功能。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>新增步驟7，說明在設定DCM資料檔案匯入至<span class="keyword"> Audience Manager</span>後，您需要執行哪些動作來啟用<span class="wintitle">可執行的記錄檔</span>。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>一種新的設定，可控制資料如何傳送至<span class="keyword"> Experience Cloud Device Co-op</span>。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>說明取消分段如何與<span class="wintitle">描述檔合併規則</span>搭配運作的新內容。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> 區段產生器的特徵和區段母體資料</a> </p> </td> 
   <td colname="col2"> <p>使用新定義修訂，說明<span class="wintitle">描述檔合併規則</span>如何影響報告編號。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> 區段產生器的特徵和區段母體資料</a> </p> </td> 
   <td colname="col2"> <p>將量度從<span class="wintitle">獨特特徵實現變更為<span class="wintitle">特徵總人口</span>。</span> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>我們檔案中的新章節，強調<span class="wintitle"> Audience Lab</span>功能的幾個使用案例。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#compare-models"> Audience Lab中的模型比較</a> </p> </td> 
   <td colname="col2"> <p>您可以在<span class="keyword"> Audience Manager</span>中使用數種不同的模型類型和來源。 <span class="wintitle"> Audience </span> Lab提供比較客戶在各個作用中模型轉換率的簡單方式。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#testing-creatives"> 測試各目標地的創意素材</a> </p> </td> 
   <td colname="col2"> <p>使用<span class="wintitle"> Audience Lab</span>測量創意人員在不同目標上所推動的轉換數。 此使用案例也可讓您測量創意素材的轉換與自然發生的轉換。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-profile-merge.md"> 描述檔合併規則常見問答集</a> </p> </td> 
   <td colname="col2"> <p>新增常見問答集，以協助回答常見的<span class="wintitle">描述檔合併規則</span>和裝置圖表問題。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>DCS HTTP回應呼叫現在包含<code> tid</code>欄位。 在發生事件時，請使用此欄位進行除錯。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>已新增附註，釐清7天和30天回顧期間僅適用於星期日<b><span class="uicontrol">日期至</span></b>日期。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新增檔案，說明<span class="keyword"> Audience Manager</span>呼叫<code> demdex.net</code>網域的原因。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md">DCS API 呼叫的支援屬性</a>。 </p> </td> 
   <td colname="col2"> <p>更新關鍵變數前置詞為<code> _p</code>，以識別Audience Manager中的私人參數。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已將進一步的搜尋和篩選功能新增至<b><span class="uicontrol">瀏覽所有特徵</span></b>進階搜尋。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>本節包含新的和修訂的內容，以支援<span class="wintitle">描述檔連結</span>和協力廠商裝置圖形選項。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">在「出站」檔案中添加可選檔案名元素<code> PID-ALIAS</code>。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修訂說明，並新增至<code> DIL.create</code>之<code> containerSNID</code>屬性的相關連結。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> 可定址對象量度</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已更新由<span class="keyword"> Audience Manager</span>處理的行動裝置ID(DAID)的預期格式。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已新增說明<span class="keyword"> Experience Cloud</span> <span class="wintitle">組織ID</span>的新項目，包括如何尋找它的資訊。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
...
[!DNL Audience Manager]發行說明和檔案的連結會變更。 有關[!DNL Experience Cloud]級別的舊更改的存檔，請參閱[上一版發行說明](https://docs.adobe.com/content/help/en/release-notes/experience-cloud/current.html)部分。
