  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D4F6BB8E192E4C1BAF1B505541A1E56E"> 
      ...
      <li id="li_85A63519222A4423B8D7A3FF90929741">已新增附註至<code> declaredId</code>變數。 使用訪客ID服務時，請以<code> setCustomerIDs</code>設定ID，而非DIL。 檢視<a href="https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html" format="https" scope="external">客戶ID與驗證狀態</a>。 </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
