...
| [描述檔合併規則增強功能](../features/profile-merge-rules/merge-rules-overview.md) | 我們已針對下列項目發佈了一系列增強功 [!UICONTROL Profile Merge Rules]能： <ul><li>現在最多可針對100種裝置，批次支援區段評估。</li><li>我們已改善特徵和區段人口族群的報告正確性。</li><li>我們已改善使用跨裝置ID產生批次檔案的精確度。</li><li>我們已更新說明檔案，並針對每個規則提供更詳細的使用案例。 請參 [閱描述檔合併規則](../features/profile-merge-rules/merge-rule-targeting-options.md)、外 [部裝置圖形使用案例](../features/profile-merge-rules/external-graph-use-cases.md)，以及描述 [檔連結裝置圖形使用案例](../features/profile-merge-rules/profile-link-use-case.md)。</li></ul> |
