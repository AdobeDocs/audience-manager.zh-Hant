...
<table id="table_9017F44983CC49E888BE3470430D7ACB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>我們更新了檔案，加入了測試群組的新搜尋和篩選功能。 請參閱<a href="../features/audience-lab/audience-lab.md#search-and-filter">搜尋和篩選測試群組</a>一節。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>對於使用Audience Manager和Adobe Analytics的客戶：Audience Manager使用者介面不允許您刪除從Analytics報表套裝自動建立的資料來源。 使用<a href="https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html" format="https" scope="external">核心服務</a>取消映射這些資料源。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>從8.0版開始，<span class="wintitle"> DIL</span>對<a href="https://docs.adobe.com/content/help/zh-Hant/id-service/using/home.translate.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a> 3.3版或更新版本有嚴格的依賴性。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> 瞭解 Data Integration Library (DIL)</a> </p> </td> 
   <td colname="col2"> <p>已修改<a href="../dil/dil-overview.md">取得和實作DIL程式碼</a>，以說明<span class="keyword"> Adobe Experience Platform Launch</span>是<span class="keyword"> Experience Cloud</span>中偏好的程式碼部署工具。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><a href="../dil/dil-class-overview/dil-create.md#dil-create"> DIL 建立</a> </td> 
   <td colname="col2"> <p>以下元素已過時，從2018年8月發行的<span class="wintitle"> DIL</span> 8.0開始： </p> <p> 
...
<table id="table_9166897029124C6782E0DE3D816CEA49"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在您<a href="../features/traits/create-onboarded-rule-based-traits.md#create-rules-based-or-onboarded-traits">在UI中建立特徵</a>後，您的使用者大約4小時後，就會開始符合規則型特徵的資格。 閱讀檔案，以取得特徵資格的詳細資訊。 </p> </td> 
  </tr> 
  <tr> 
