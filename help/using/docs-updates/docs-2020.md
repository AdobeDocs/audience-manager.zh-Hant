...
| 主題 | 說明 |
|---- |----|
| Audience Manager](/help/using/overview/accessibility-in-aam.md)中的[協助工具 | 協助工具是指讓軟體產品可供使用的一系列功能，具有各種殘障（例如視覺、聽覺、認知、運動或其他殘障）的使用者可儘可能減少工作量。 為了讓Audience Manager更易於每個人使用，我們已開發出對多項協助工具功能的支援，本文對此有詳細說明。 |
