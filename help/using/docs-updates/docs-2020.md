...
| [如何將資料從Adobe Analytics轉送至Audience Manager](../integration/integration-other-solutions/audience-management-module.md) | 我們更新本頁以反白標示Adobe Experience Platform Launch，這是將資料從Adobe Analytics轉送至Audience Manager的偏好方式。 |
