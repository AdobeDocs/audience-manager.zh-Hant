...
| 主題 | 說明 |
|---- |----|
| [Audience Manager中的協助功能](../overview/accessibility-in-aam.md) | 協助功能是指讓軟體產品可供使用的一系列功能，讓視覺、聽覺、認知、運動或其他殘障人士盡可能少的努力。 為了讓Audience Manager更容易為每個人使用，我們開發了多種協助工具功能支援，詳細說明請參閱本文。 |
