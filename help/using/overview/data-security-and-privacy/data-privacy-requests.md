...
本檔案提供管理個別資料隱私權和退出要求的概述，您可透過 [Privacy Service UI和](https://gdprui.cloud.adobe.io/) ，將這些要求傳送至Audience Manager **[!DNL Privacy Service API]**。
