...
本頁僅包含目 [!DNL Audience Manager] 前 [的裝置型目標](/help/using/features/destinations/add-device-based-destinations.md) 。 在中 [!DNL Audience Manager], [!UICONTROL device-based destinations] 也稱為 [!UICONTROL server-to-server destinations]。 如需整合的詳細資訊，請參閱 [Adobe Exchange清單](https://www.adobeexchange.com/experiencecloud.html) （如有），或聯絡您的 [!DNL Adobe] 顧問或客戶服務。
...
| 整合 | 最近更新 | 更新 | 取消分段 | 接收 [!DNL IAB TCF] 許可信號 | [!DNL ICDS] | 行動裝置 ID |
|---------------------------------------------------|------------|-----------|-----------|-----------------------------------|------|-------------------|
...
| [!DNL Amazon Advertising] | 15/06/2017 | 1xday | 有 | 否 | 否 | 否 |
...
| [!DNL Lotame] | 30/06/2017 | 1xday | 有 | 否 | 否 | 是 |
...
| [!DNL Narrative I/O] | 12/01/2018 | 1xday | 有 | 否 | 否 | 是 |
...
| [!DNL Opera Mediaworks] | 13/02/2017 | 1xday | 有 | 否 | 否 | 是 |
...
| [!DNL Pulsepoint] | 13/02/2017 | 1xday | 有 | 否 | 否 | 否 |
...
| [!DNL SpotX] | 16/03/2018 | 1xday | 否 | 有 | 否 | 是 |
...
| [!DNL Tapad] | 03/03/2017 | 即時 | 否 | 否 | 否 | 是 |
...
| [!DNL Twitter Tailored Audiences] | 27/03/2017 | 即時 | 有 | 否 | 有 | 否 |
| [!DNL Undertone] | 11/07/2017 | 1xday | 否 | 否 | 否 | 否 |
| [!DNL Verve] | 15/06/2017 | 1xday | 有 | 否 | 否 | 是 |
