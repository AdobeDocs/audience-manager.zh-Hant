---
description: 此頁面包含分步指南，說明如何將離線CRM資料與Audience Manager中已有的行為資料結合，以建立新的受眾區段，然後將這些受眾區段傳送至「以人物為基礎的目的地」。
...
此頁面包含如何結合離線[!DNL CRM]資料與您Audience Manager中已有之行為資料的逐步指引，以建立新的對象區段，然後將這些對象區段傳送至[!DNL People-Based Destinations]。
