---
description: 合併規則選項可讓您控制用於分段的資料Audience Manager類型。 合併規則可包含由「設定檔連結」裝置圖形、Adobe Experience Cloud裝置合作社和／或其他與Audience Manager整合的第三方裝置圖形提供者所映射的裝置設定檔。 您最多可以建立4個配置檔案合併規則。
seo-description: 合併規則選項可讓您控制用於分段的資料Audience Manager類型。 合併規則可包含由「設定檔連結」裝置圖形、Adobe Experience Cloud裝置合作社和／或其他與Audience Manager整合的第三方裝置圖形提供者所映射的裝置設定檔。 您最多可以建立4個配置檔案合併規則。
...
[!UICONTROL Cross-Device Options]可讓您選取已驗證和未驗證的使用者，並運用其跨裝置設定檔進行分段。 這些選項可協助您識別並觸及共用裝置上的特定使用者。 如需匿名和已驗證使用者的詳細資訊，請參閱Audience Manager](../../reference/visitor-authentication-states.md)中的[訪客驗證狀態。
...
<table id="table_4CE2DD312F54480E96BEAF72800789FB"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>告知<span class="keyword">Audience Manager</span>不要使用從已驗證用戶收集到的資料。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b><span class="uicontrol"> 目前已驗證的設定檔</span></b> </p> </td> 
   <td colname="col2"> <p>告知<span class="keyword">Audience Manager</span>如果訪客已登入您的網站，請將資料讀入已驗證的描述檔。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b><span class="uicontrol"> 上次驗證的設定檔</span></b> </p> </td> 
   <td colname="col2"> <p>通知<span class="keyword">Audience Manager</span>從上次登錄設備的用戶的已驗證配置檔案中讀取資料。 </p> <p>如果選取此選項，<span class="keyword">Audience Manager</span>將不會將新特徵資料寫入已驗證的設定檔（如果使用者是匿名的）。 在驗證時，新特徵資料會寫入使用者的驗證設定檔。 </p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b><span class="uicontrol"> 所有跨裝置描述檔</span></b> </p> </td> 
   <td colname="col2"> <p>告知Audience Manager從所有跨裝置描述檔讀取資料，而不論驗證狀態為何。 此選項僅適用於購買「以人為本的目的地」附加元件的Audience Manager客戶。</p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_D373FB787D1A4E3485C02C4A76F03395"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>通知<span class="keyword">Audience Manager</span>從當前設備和多達100台用戶已通過身份驗證的其他設備讀取配置檔案。 此裝置圖表是以您自己的<span class="keyword">Audience Manager</span>第一方資料為基礎。 它最適合在數位資產中擁有高等級驗證的客戶。 <span class="wintitle">描述檔連結</span>裝置圖形即時更新。 當您選擇<b><span class="uicontrol">目前已驗證的設定檔</span></b>或<b><span class="uicontrol">上次已驗證的設定檔</span></b>時，此選項可用。 使用此選項時，您只能選擇單一已驗證的描述檔(<span class="keyword">Audience Manager</span>會自動將其他描述檔灰化)。 另請參閱<a href="profile-link-use-case.md">描述檔連結裝置圖表使用案例</a>。 </p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b><span class="uicontrol"> Co-op裝置圖表</span></b> </p> </td> 
   <td colname="col2"> <p>指示<span class="keyword">Audience Manager</span>使用<a href="https://docs.adobe.com/content/help/en/device-co-op/using/about/overview.html" format="https" scope="external">Experience Cloud設備Co-op</a>提供的連結從當前設備和多達100個其它設備讀取配置檔案。 </p> <p><span class="keyword"> Device Co-op</span> 是數位合作社，參與客戶在此分享裝置連結資訊。<span class="keyword"> Device Co-op</span>在<span class="term">設備圖表</span>中處理此資料。 裝置圖形將裝置連結在一起，形成裝置叢集。 這些連結是從<a href="https://docs.adobe.com/content/help/en/device-co-op/using/device-graph/links.html" format="https" scope="external">概率與確定性資料</a>建立。 群集表示未知人員使用的一組設備。 <span class="keyword">Device Co-op</span> 會在其成員間分享這些叢集，如此有助於它們為其客戶提供珍貴而一致的跨裝置體驗。 </p> <p> 有關<span class="wintitle"> Device Co-op</span>的詳細資訊，請參閱： </p> <p> 
...
根據在[!DNL Audience Manager]之外定義的合併規則，從其他[!DNL Experience Cloud]解決方案自動建立的讀者區段會標示為使用[!UICONTROL External Merge Policy]。 例如，請參閱[Audience Manager與Adobe Experience Platform之間的觀眾分享](../../integration/integration-aep/aam-aep-audience-sharing.md)。
