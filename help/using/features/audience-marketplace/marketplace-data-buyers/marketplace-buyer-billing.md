...
# 為資料饋送購買者計費 {#billing-for-data-feed-buyers}
...
<table id="table_BF00FE6740D2459DAFA62F2478492586"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在使用布林OR條件的規則型區段中，將已傳遞印象總計的加權分配套用至所有提供者特徵。 加權分配乃使用下列公式計算：</p><p><code>（特徵人口／區段人口）*曝光數* CPM成本</code></p> </td> 
  </tr>
  <tr> 
...
例如，假設您決定在月中旬開啟動態消息中的特定特徵。 無論您是在何時開始訂閱或啟動特定特性，您仍會以每月全額收費。